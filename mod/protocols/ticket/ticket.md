...
==- **Ticket de gestión**
Este tickets solo puede ser abierto por [!button variant="info" text="@Moderadores" size="xs"] o rangos superiores. Se utiliza para citar a usuarios o tratar casos particulares, como errores en eventos, revisiones de comportamiento o la comunicación de advertencias importantes (ultimátums).
==-
